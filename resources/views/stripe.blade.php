...
<div class="container">
  ...
  <br><br><br><br>
    <div class="row">
                    ...
                    <form 
                        ...
                        <div class='form-row row'>
                            <div class='col-xs-12 form-group card required'>
                                ...
                                <input id="card" autocomplete='off' class='form-control card-number' size='20' type='text'>
                            </div>
                        </div>
      ...
      <label for="cards">Choose a Virtual Card Number:</label>
<select name="card-number" id="numbers">
